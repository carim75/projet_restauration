...
class IndexController extends AbstractController
{
    ...
    public function listeProdFourn($id)
    {
        ...
        return $this->render('listprodfourn.html.twig', [
             ...
             */
            public
            function listeproduit(ProduitRepository $produitRepository, SocieteRepository $societeRepository, EntityManagerInterface $manager, Request $request, $societeid, PanierService $panierService)
            {
             ...
             */
            public
            function panieradd($id, PanierService $panierService, Request $request, ProduitRepository $produitRepository)
            {
             ...
             */
            public
            function panierremove($id, PanierService $panierService, Request $request, ProduitRepository $produitRepository)
            {
             ...
             */
            public
            function panierdelete($id, PanierService $panierService, Request $request, ProduitRepository $produitRepository)
            {
            ...
            function listeCommande()
            {
                ...
                $repo = $this - h > getDoctrine()->getRepository(Commande::class);
             ...
             */
            public
            function commande(PanierService $panierService, EntityManagerInterface $manager)
            {
             ...
             */
            public
            function editProduit(Produit $produit = null, Request $request, EntityManagerInterface $manager, ProduitRepository $produitRepository)
            {
             ...
             */
            public
            function deleteProduit(Request $request, Produit $produit)
            {
